...
public class TechGlobalSteps {
    ...
    TechGlobalDynamicTablePage techGlobalDynamicTablePage;
    ...
    public void setDriver() {
        ...
        techGlobalDynamicTablePage = new TechGlobalDynamicTablePage();
    }
    ...
    public void user_should_see_the_heading(String headingText) {
        Assert.assertEquals(headingText, techGlobalDynamicTablePage.headingText.getText());
    }
    ...
    public void user_clicks_the_button(String argument) {
        ...
        switch (argument) {
            case "ADD PRODUCT":
                techGlobalDynamicTablePage.addProductButton.click();
                break;
            case "CLOSE":
                techGlobalDynamicTablePage.closeButton.click();
                break;
            default:
                throw new NotFoundException("The error message is not defined properly in the feature file");
        }
    ...
    public void validate_pop_up_is_displayed() {
        Assert.assertTrue(techGlobalDynamicTablePage.modalCardTitle.isDisplayed());
    }

    @Then("user should not see Add New Product pop-up")
    public void user_should_not_see_add_new_product_pop_up() {
        try {
            Assert.assertFalse(techGlobalDynamicTablePage.modalCardTitle.isDisplayed());
        } catch (NoSuchElementException e) {
            Assert.assertTrue(true); // to validate modal is closed
        }
    }
}